...
const ActionButton = ({ children }: { children: React.ReactNode }) => (
  <motion.button
    ...
    whileTap={{ scale: 0.95 }}
    className="mt-8 px-8 py-3 rounded-full bg-accent text-accent-foreground font-semibold shadow-lg transition-colors hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-opacity-75"
  >
    {children}
  </motion.button>
);
