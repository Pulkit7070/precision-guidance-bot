            ...
            <div className="relative py-3 sm:py-4 md:py-6 md:w-[calc(100%-17rem)]">
              ...
              >
                <CarouselContent className="-ml-3">
                  <CarouselItem className="flex basis-1/3 justify-center pl-3 sm:basis-1/4 md:basis-1/5 lg:basis-1/6">
                    <div className="flex shrink-0 items-center justify-center bg-card border border-border rounded-lg natural-shadow hover:shadow-md transition-all w-24 h-16 sm:w-32 sm:h-20 md:w-40 md:h-24 p-2 sm:p-3">
