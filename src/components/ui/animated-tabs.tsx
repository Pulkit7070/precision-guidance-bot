    ...
    content: (
      <div className="grid grid-cols-2 gap-4 w-full h-full">
        ...
        <div className="flex flex-col gap-y-2">
          <h2 className="text-2xl font-bold mb-0 mt-0 !m-0">Tab 1</h2>
  ...
  },
  {
    ...
    content: (
      <div className="grid grid-cols-2 gap-4 w-full h-full">
        ...
        />
        <div className="flex flex-col gap-y-2">
          <h2 className="text-2xl font-bold mb-0 mt-0 !m-0">Tab 2</h2>
          <p className="text-sm mt-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos.
          </p>
        </div>
  ...
  },
  {
    ...
    content: (
      <div className="grid grid-cols-2 gap-4 w-full h-full">
        ...
        />
        <div className="flex flex-col gap-y-2">
          <h2 className="text-2xl font-bold mb-0 mt-0 !m-0">Tab 3</h2>
          <p className="text-sm mt-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos.
          </p>
        </div>
        ...
        {tabs.map((tab) => (
          ...
          >
            {activeTab === tab.id && (
              <motion.div
                layoutId="active-tab"
                className="absolute inset-0 bg-card backdrop-blur-sm !rounded-lg natural-shadow"
